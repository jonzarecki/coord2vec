...
def save_all_py_files():
    ...
    tmp_expr_foldpath = file_util.create_temp_folder(prefix=TMP_EXPR_FILES_DIR)
    python_files_in_dir = list_all_files_in_folder(PROJECT_ROOT, "py", recursively=True)
    file_util.copy_files_while_keeping_structure(python_files_in_dir, PROJECT_ROOT, tmp_expr_foldpath)
