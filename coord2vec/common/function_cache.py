...
# TODO: can add option to save cache in parallel, takes time
# TODO: can load cache from beginning using parallel load (will be shared with different caches)
# TODO: can add option to save different caches to different runs by using "experiment_params"
# TODO: can save only the differented new cache entries and only once in a while save and combine them
# TODO: add option to space-saving functions and reloading function (like in text_modop save_mem/back_to_normal)
def func_cache(func):
    name = func.func_name
