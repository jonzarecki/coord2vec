...
from coord2vec.config import IMG_WIDTH, IMG_HEIGHT, tile_server_dns_noport
...
class TestTileImage(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.s = generate_static_maps(tile_server_dns_noport, [8080, 8081])
    ...
    def test_rendering_multi_channel_image_works(self):
        ...
        self.assertTupleEqual((2, IMG_HEIGHT, IMG_WIDTH), image.shape)
