...
def main( args ):
    ...
    junks.append(skimage.io.imread("/media/yonatanz/yz/data/NUS-WIDE/junk.gif"))
...
def parse_args():
    ...
    parser.add_argument("--url_dir",
                        type=str,
                        default="/media/yonatanz/yz/data/NUS-WIDE/",
                        help="Dir which NUS-WIDE-urls file located. \
              (default is ./)")
    parser.add_argument("--save_dir",
                        type=str,
                        default="/media/yonatanz/yz/data/NUS-WIDE/image",
